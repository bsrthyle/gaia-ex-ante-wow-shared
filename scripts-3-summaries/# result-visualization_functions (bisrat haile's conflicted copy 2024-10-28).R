...
create_and_save_raster_plots <- function(country_iso3,
  ...
  lime_rate_bean <- terra::crop(exante_output[[grep('BEAN_lr_tha', names(exante_output))]] * exante_output[["BEAN"]], cty_1, mask = TRUE)
  ...
  yield_loss_bean <- terra::crop(exante_output[[grep('BEAN_loss', names(exante_output))]], cty_1, mask = TRUE)
  ...
  yield_response_bean <- terra::crop(exante_output[[grep('BEAN_yresp_tha', names(exante_output))]], cty_1, mask = TRUE)
  
  roi_maize <- terra::crop(exante_output[[grep('MAIZ_roi_usha', names(exante_output))]], cty_1, mask = TRUE)
  roi_bean <- terra::crop(exante_output[[grep('BEAN_roi_usha', names(exante_output))]], cty_1, mask = TRUE)
  ...
  raster_pairs <- append(raster_pairs, list(
    ...
    list(
      ...
      title2 = 'Bean Yield Response (t/ha)',
...
write_latex_slidedeck <- function(country_code, report_path, level_name, figures_and_tables_path) {
  ...
  latex_content <- paste0(
    ...
    "    \\begin{figure}\n",
    "    \\includegraphics[width=0.85\\textwidth, height=0.80\\textheight]{", file.path(figures_and_tables_path, paste0(country_code, "_plt_acidic_cropland.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n\n",
    ...
    "    \\begin{figure}\n",
    "    \\includegraphics[width=0.85\\textwidth, height=0.80\\textheight]{", file.path(figures_and_tables_path, paste0(country_code, "_plt_acidic_cropland_perc.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n\n",
    ...
    "    \\begin{center}\n",
    "        \\includegraphics[scale=0.45]{", file.path(figures_and_tables_path, paste0(country_code, "_plt_crop_area_acidic.png")), "}\n",
    "    \\end{center}\n",
    "\\end{frame}\n\n",
    "\\begin{frame}\n",
    "    \\scriptsize\n",
    ...
    "\\end{frame}\n\n",
    "\\section{Yield Loss}\n",
    "\\subsection*{Yield loss for Maize and Beans (\\%) in ", country_name, "}\n",
    "\\begin{frame}{Yield loss due to soil acidity for Maize and Beans in ", country_name, "}\n",
    "    \\begin{figure}\n",
    "    \\includegraphics[width=\\textwidth]{", file.path(figures_and_tables_path, paste0(country_code, "_yield_loss.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n\n",
    ...
    "    \\begin{figure}\n",
    "        \\centering\n",
    "        \\includegraphics[scale=0.45]{", file.path(figures_and_tables_path, paste0(country_code, "_plt_lime_requirements.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n\n",
    ...
    "\\end{frame}\n\n",
    "\\subsection*{Lime rate for Maize and Beans in ", country_name, "}\n",
    "\\begin{frame} {Lime rate for Maize and Beans in ", country_name, "}\n",
    "    \\begin{figure}\n",
    "        \\centering\n",
    "        \\includegraphics[width=\\textwidth]{", file.path(figures_and_tables_path, paste0(country_code, "_lime_rate.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n\n",
    ...
    "    \\begin{figure}\n",
    "        \\centering\n",
    "        \\includegraphics[width=\\textwidth]{", file.path(figures_and_tables_path, paste0(country_code, "_yield_response.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n\n",
    ...
    "    \\begin{figure}\n",
    "    \\includegraphics[width=\\textwidth, height=0.85\\textheight]{", file.path(figures_and_tables_path, paste0(country_code, "_plt_additional_production.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n\n",
    ...
    "    \\begin{figure}\n",
    "    \\includegraphics[width=\\textwidth, height=0.85\\textheight]{", file.path(figures_and_tables_path, paste0(country_code, "_plt_additional_production_value.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n\n",
    ...
    "    \\begin{figure}\n",
    "        \\centering\n",
    "        \\includegraphics[width=\\textwidth]{", file.path(figures_and_tables_path, paste0(country_code, "_roi.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n\n",
    ...
    "    \\begin{figure}\n",
    "        \\centering\n",
    "        \\includegraphics[width=\\textwidth]{", file.path(figures_and_tables_path, paste0(country_code, "_profit.png")), "}\n",
    "    \\end{figure}\n",
    "\\end{frame}\n",
    "\\begin{frame}\n",
    ...
    \\item Crop prices are spatially constant; the median crop price across all countries for the period 2016--2020 was used throughout the analysis.
    \\item Lime prices are assumed to be \\$100 per tonne.,
    \\item Profitability is calculated only for the first year.
\\end{itemize}\n",
    "\\end{frame}\n\n",
    "\\end{document}"
  )
